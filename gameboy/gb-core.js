...
function Emitter(obj) {
  ...
  obj.emit = function (name) {
    var list = this._listeners && this._listeners[name];
    var args = Array.prototype.slice.call(arguments, 1);
    if (list) list.slice().forEach(function (fn) { fn.apply(this, args); }, this);
    else if (name === 'error' && args[0]) console.error(args[0]);
    return this;
  };
  return obj;
}
...
if (typeof module !== 'undefined' && module.exports) module.exports = GameBoyCore;
else root.GameBoyCore = GameBoyCore;
